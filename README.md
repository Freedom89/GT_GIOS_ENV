...
Fall 2022 will be using an Ubuntu 20.04 environment for grading; we _recommend_
...
* **Dockerfile** -- use this if you wish to construct your own Docker image (you
  ...
  [docker.com](https://hub.docker.com/repository/docker/gtomscs6200/fall22-environment).
...
**Note: We are in the process of setting up the submission mechanism for Fall 2022.  We will advise you of the correct steps and update this document.**
